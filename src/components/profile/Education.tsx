      ...
      <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
       ...
       <div className="bg-card rounded-lg p-4 sm:p-6 border border-border">
          ...
          <div className="relative">
            <div className="absolute left-0 top-0 bottom-0 w-0.5 bg-gradient-to-b from-accent to-portfolio-cool/30"></div>
            {educationTimeline.map((edu, index) => (
              ...
              >
                <div className="absolute -left-[7px] top-1/2 -translate-y-1/2 w-3.5 h-3.5 rounded-full bg-gradient-to-r from-accent to-portfolio-cool shadow-sm"></div>
                <div>
        ...
        {/* Educational Skills */}
        <div className="bg-background rounded-lg p-4 sm:p-6 shadow-lg border border-border">
