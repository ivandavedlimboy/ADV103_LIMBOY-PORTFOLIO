...
const Journal = () => {
  ...
  return (
    <div className="h-full bg-background flex flex-col overflow-hidden transition-colors duration-300 ease-in-out">
      ...
      <div className="bg-background py-6 px-6 transition-colors duration-300 ease-in-out flex-shrink-0">
        <div className="max-w-4xl mx-auto text-center animate-fade-in">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-1 sm:mb-3">Journal</h1>
      ...
      {/* Main Content Area */}
       <div className="flex flex-col md:flex-row flex-1 overflow-hidden gap-4 px-4 pt-4 pb-1">
        ...
        {selectedJournal && selectedEntry && (
          <div
            className={`
              flex-1 bg-card rounded-xl shadow-lg overflow-y-auto transition-colors duration-300 ease-in-out
              [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]
              animate-fade-in
              py-3
            `}
